...
const { cors } = require("./src/lib/middleware");
const js6c1 = require("./src/js6c1");
const js6c2 = require("./src/js6c2");
...
app.use("/js6c1", js6c1);
app.options("/js6c2/graphql", cors(), (req, res, next) => {
  res.end();
});
app.use("/js6c2", js6c2);
